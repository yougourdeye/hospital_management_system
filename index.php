...
<head>
    ...
    <title>The National Reference General Hospital </title>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">The National Reference General Hospital</h5>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                <h3>The National Reference General Hospital</h3>
<?php
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/images/gallery/gallery_012.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="assets/images/gallery/gallery_014.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/images/gallery/gallery_013.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                <img src="assets/images/gallery/gallery_016.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_015.jpg" class="img-responsive">
            </div>

          

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_011.jpg" class="img-responsive">
            </div>
...
<a href="<?php echo $mailto_link; ?>">Email: info@gmail.com</a>
    ...
    <div class="copy">
            <div class="container">
            The National Reference General Hospital Of N'Djamena
            </div>
